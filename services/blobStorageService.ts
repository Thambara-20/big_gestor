...
// These environment variables must be configured for the app to work.
...
if (supabaseUrl && supabaseAnonKey) {
  ...
  console.warn("[SupabaseService] Supabase environment variables (SUPABASE_URL, SUPABASE_ANON_KEY) are not set. Data persistence will be disabled.");
  isPersistenceEnabled = false;
}
